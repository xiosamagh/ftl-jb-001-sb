...
public class HelloWorldApiController {
    ...
    public IndexResponse getExampleWithParam(@RequestParam String param1, @RequestParam(value = "p_a_r_a_m_2") String param2,
                                             @RequestParam(required = false, defaultValue = "def") String param3, @RequestParam(required = false) String param4){
    ...
    public IndexResponse getExampleWithPath(
        ...
        return IndexResponse.builder().message(pathVariable).build();
    }
    ...
    public IndexResponse put(@PathVariable String id,
                             @RequestBody PostRequest request) {
    ...
    public IndexResponse delete(@PathVariable String id) {
        return IndexResponse.builder().message(id).build();
    }
}
